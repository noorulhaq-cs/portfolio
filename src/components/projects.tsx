                ...
                <div className="relative h-48 w-full shrink-0 overflow-hidden border-b border-border bg-surface-2">
                  {project.image ? (
                    <img
                      src={project.image}
                      alt={project.title}
                      /* object-cover: Image stretch nahi hogi, proportional zoom hogi.
                        object-top: Image ko upar se align rakhega aur sirf niche se extra hissa crop (cut) karega.
                      */
                      className="h-full w-full object-cover object-top group-hover:scale-[1.02] transition-transform duration-500 ease-out"
                    />
                  ) : (
                    // Fallback mesh design
                    <>
                      <div
